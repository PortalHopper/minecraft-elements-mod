...
public class MyEntityMinion extends EntityTameable
{
    ...
    public MyEntityMinion(World par1World)
    {
        ...
        this.tasks.addTask(5, new EntityAIFollowOwner(this, 0.8D, 10.0F, 2.0F));
    ...
    {
        return this.isAngry() ? "mob.wither.shoot" : (this.rand.nextInt(3) == 0 ? (this.isTamed() && this.dataWatcher.getWatchableObjectFloat(18) < 10.0F ? "mob.wolf.whine" : "mob.wolf.panting") : "mob.wolf.bark");
    }
    ...
    public boolean interact(EntityPlayer par1EntityPlayer)
    {
        ...
        else if (itemstack != null && itemstack.itemID == Main.MyItem_1.itemID && !this.isAngry())
        {
            if (!par1EntityPlayer.capabilities.isCreativeMode)
            {
                --itemstack.stackSize;
    ...
    {
        MyEntityMinion entitywolf = new MyEntityMinion(this.worldObj);
    ...
    public boolean canMateWith(EntityAnimal par1EntityAnimal)
    {
        ...
        else if (!(par1EntityAnimal instanceof MyEntityMinion))
        {
            return false;
        }
        else
        {
            MyEntityMinion entitywolf = (MyEntityMinion)par1EntityAnimal;
    ...
    public boolean func_142018_a(EntityLivingBase par1EntityLivingBase, EntityLivingBase par2EntityLivingBase)
    {
        ...
        {
            if (par1EntityLivingBase instanceof MyEntityMinion)
            {
                MyEntityMinion entitywolf = (MyEntityMinion)par1EntityLivingBase;
